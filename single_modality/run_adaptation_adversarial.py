...
from engines.engine_for_domainadv import train_one_epoch, validation_one_epoch, validation_one_epoch_teacher, final_test, merge
...
def main(args, ds_init):
    ...
    if args.enable_deepspeed:
        ...
        if args.distributed:
            ...
            utils.load_model_colab(model_engine=None, model=model, output_dir=args.finetune, model_name=None, deepspeed=False, strict=False)
