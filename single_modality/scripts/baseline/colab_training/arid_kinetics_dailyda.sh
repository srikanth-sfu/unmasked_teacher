...
#SBATCH --time=0-03:00
#SBATCH -o /home/smuralid/error/umt_domainloss/adapt/dailyda/arid_k600/slurm-%j.out  # Write the log on scratch
#SBATCH -e /home/smuralid/error/umt_domainloss/adapt/dailyda/arid_k600/slurm-%j.err
...
cd unmasked_teacher
git checkout umt_videodomainloss
cd single_modality

timeout 170m bash exp/video_domainloss_adapt/videodomainloss_adapt_b16_aridkt_f8_res224.sh
